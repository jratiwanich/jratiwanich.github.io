...
if ( $_POST["enter"] ) {
 ...
 //var_dump($_POST);
  ...
  $url = "https://www.google.com/recaptcha/api/siteverify";
	$key = "6LcbnHAUAAAAAOPG7UFH3PBsQq05anpz-wXI3nBZ";
  ...
  if ( $data->success == false) {
    ...
    $mail->setFrom('hello@dolosplus.com', 'dolosplus.com'); 
    ...
    $mail->addAddress('hello@dolosplus.com'); //**WRITE HERE RECIPIENT EMAIL ADDRESS (AT THIS ADDRESS EMAILS WILL BE COME)**
